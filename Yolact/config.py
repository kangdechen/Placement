...
my_custom_dataset = dataset_base.copy({
    ...
    'train_images': './data/coco/train/apple_pie',
    'train_info':   './data/coco/annotations/apple_pie_train.json',

    'valid_images': './data/coco/val/apple_pie',
    'valid_info':   './data/coco/annotations/apple_pie_val.json',


    'class_names': ('apple pie' ),
    'label_map':{1:1}
})
